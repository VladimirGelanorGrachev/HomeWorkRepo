...
/// </summary>
    class Program
    {
        ...
        static void Task2()
        {
            Console.WriteLine("Укажите чилсо не больше 10000: ");
        ...
        static void Task4()
        {
            ...
            Console.WriteLine($"вы не прошли проверку пароля {count} раза. доступ заблокирован." +
        ...
        /// <summary>
        /// Подсчет хороших чисел от 1 до 1 000 000 000
        /// </summary>
        static void Task6()
        {
            Console.WriteLine("для продолжения нажмите Enter");
